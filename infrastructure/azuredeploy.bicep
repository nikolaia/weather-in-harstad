...
param webAppName string = 'weather-in-harstad'

@description('The minimum loglevel for Serilog to push')
param serilogLogLevel string = 'Information'

var resourceGroupLocation = location
var appNameShort = substring(webAppName, 0, 5)
var containerRegistryName = '${appNameShort}ACR${uniqueString(resourceGroup().id)}'
...
var managedIdentityName = 'weather-in-harstad-deploy'
...
output deploymentSP object = roleAssignment
